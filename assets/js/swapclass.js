...
function initData() {
	...
	for(var i = 0; i < 10; i++){
		$("#classoffers_swap").append("<li class='list-group-item'>"
				...
				+ "<input class='d-inline float-right' type='radio' style='padding: 10px;height: 25px;width: 25px;margin: 10px;'></li>");

		$("#myclasses_swap").append("<li class='list-group-item text-nowrap text-left d-inline-block flex-row flex-nowrap'>"
